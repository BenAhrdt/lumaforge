...
build/lumaforge-engine: build $(CORE_SRC) core/src/engine_main.cpp core/include/lumaforge/core.hpp
	$(CXX) $(CXXFLAGS) $(CORE_SRC) core/src/engine_main.cpp -o $@

build/core-tests: build $(CORE_SRC) core/tests/core_tests.cpp core/include/lumaforge/core.hpp
